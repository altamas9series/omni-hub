...
import { TrendingUp, Briefcase, Crown, Settings, CreditCard, Building2, ShoppingCart, Landmark } from "lucide-react";

const iconMap: Record<string, React.ElementType> = { TrendingUp, Briefcase, Crown, Settings, CreditCard, Building2, ShoppingCart, Landmark };
