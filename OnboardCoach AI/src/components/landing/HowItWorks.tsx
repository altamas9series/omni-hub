...
const iconMap: Record<string, ElementType> = { Plug, Brain, MessageSquare, BarChart3, FileStack, Send, Upload, Route, HelpCircle, Award };
      ...
      <div className="container mx-auto max-w-5xl relative">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-foreground tracking-tight">
            {isDefaultTitle ? (
              <>
                How <span className="text-gradient">{brand.name} {brand.nameAccent}</span> Works
              </>
            ) : (
              howItWorks.title
            )}
