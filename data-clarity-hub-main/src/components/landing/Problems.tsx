...
import { Layers, Clock, EyeOff, Lock, Hourglass, FileText, DollarSign } from "lucide-react";

const iconMap: Record<string, React.ElementType> = { Layers, Clock, EyeOff, Lock, Hourglass, FileText, DollarSign };
